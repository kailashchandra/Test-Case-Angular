...
export class EmployeeComponent implements OnInit {
  ...
  public displayedColumns = ['employeeId', 'firstName', 'lastName', 'emailAddress', 'actions'];
  ...
  addOrUpdateEmployee() : void {
    if(this.employeeId == undefined || this.firstName == undefined ||  this.lastName == undefined || this.emailAddress == undefined){
      return;
    }

    let emp = new Employee(this.employeeId, this.firstName, this.lastName,  this.emailAddress);
